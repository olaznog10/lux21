...
class Cell:
    ...
    def __str__(self):
        if self.citytile:
            return f"Cell | x:{self.pos.x} y: {self.pos.y} city:{self.citytile.team} resource:{self.has_resource()} road: {self.road}"
        else:
            return f"Cell | x:{self.pos.x} y: {self.pos.y} city:{self.citytile} resource:{self.has_resource()} road: {self.road}"
