...
class Player:
    ...
    def __str__(self) -> str:
        return f"Player | Team:{self.team} CityId:{self.research_points} TileCount:{self.city_tile_count}"
...
class City:
    ...
    def __str__(self) -> str:
        return f"City:{self.id} | Team:{self.team} CityId:{self.cityid} Fuel:{self.fuel} Light:{self.light_upkeep}"
...
class Unit:
    ...
    def __str__(self) -> str:
        return f"Unit:{self.id} | Team:{self.team} {self.cargo}"

    def cargo_to_fuel(self) -> int:
        return (self.cargo.wood * GAME_CONSTANTS['PARAMETERS']['RESOURCE_TO_FUEL_RATE']['WOOD']) + (self.cargo.coal * GAME_CONSTANTS['PARAMETERS']['RESOURCE_TO_FUEL_RATE']['COAL']) + (self.cargo.uranium ** GAME_CONSTANTS['PARAMETERS']['RESOURCE_TO_FUEL_RATE']['URANIUM'])
